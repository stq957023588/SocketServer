...
public class LopezEmail {
	...
	private LopezEmail(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,
	 ...
	 * @return
	 */
	public static LopezEmail entity(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,
			List<String> attachments) {
		return new LopezEmail(smtpHost, sendUserName, sendUserPass, to, cc, mailSubject, mailBody, attachments);
	}
	 ...
	 * @return
	 */
	public static LopezEmail defaultEntity(String to, String cc, String subject, String body, List<String> attachments) {
		return new LopezEmail(defaultSmtpHost, defaultSenderName, defaultSenderPass, to, cc, subject, body, attachments);
	}
